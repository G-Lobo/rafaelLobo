...
@section('content')
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-wrap space-x-2 mb-10">
                        ...
                        @foreach ($post->filmAreas as $area)
                            <span
                                class="bg-green-100 text-green-800 text-sm font-medium px-2.5 py-0.5 rounded">{{ $area->area }}</span>
                        @endforeach
                    </div>
                    <!-- Content -->
            ...
            <div class="flex-column">
                ...
                <div class="flex flex-col justify-between">
                    ...
                    <div class="flex space-x-4 text-gray-600 mb-4 justify-center">
                        ...
                        <span class="flex items-between items-center">
                            <svg class="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 8H9V5a1 1 0 112 0v5z"></path>
                            </svg>
                            {{ $post->duration }} minutos
                    ...
                    <!-- Type and Areas -->
                    <div class="flex flex-wrap space-x-2 mb-4 justify-center">
                        <span
                            class="bg-blue-100 text-blue-800 text-sm font-medium px-2.5 py-0.5 rounded">{{ $type->type }}</span>
                        @foreach ($post->filmAreas as $area)
                            <span
        ...
        @if ($post->prizes->isNotEmpty())
            <div class="flex flex-wrap space-x-4 mb-4">
                @foreach ($post->prizes as $prize)
                    <img src="{{ asset('assets/img/prizes/' . $prize->image) }}" alt="{{ $prize->name }}"
    ...
    <!-- Video Player -->
    @if ($post->videoLink)
        <div class="container mx-auto px-5 xl:px-64 pb-8">
