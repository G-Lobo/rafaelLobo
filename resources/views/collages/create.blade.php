...
<div class="max-w-5xl mx-auto p-8 bg-gray-100 shadow-lg rounded-xl mt-8">
    ...
    <form action="/art" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf

        <div>
            <label for="title" class="block text-lg font-medium text-gray-700">Nome da Coleção:</label>
